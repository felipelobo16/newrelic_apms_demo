...
var userlogger = require('./logger.js')
var fs = require('fs');
...
exports.start = function(PORT, STATIC_DIR, DATA_FILE, TEST_DIR) {
  ...
  app.post(API_URL, function(req, res, next) {
    ...
    userlogger.error('Error ao escolher o restaurante');
  ...
  app.post(API_URL_ORDER, jsonParser, function(req, res, next) {
    ...
    newrelic.recordMetric('Cart/ChargeAmount', orderTotal);
  ...
  app.get(API_URL_ID, function(req, res, next) {
    ...
    userlogger.error({error: 'No restaurant with id "' + req.params.id + '"!'});
